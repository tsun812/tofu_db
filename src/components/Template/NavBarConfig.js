        ...
        <nav className="sidebar__menu">
          <Form>
            <Field
              ...
              fields={props.fields}
              name="Primary field"
              selected={props.primaryField}
              setPrimaryField={props.setPrimaryField}
            ...
            <Field
              ...
              selected={props.secondaryField}
              setSecondaryField={props.setSecondaryField}
              applicationID={props.applicationID}
              fieldsArray={props.fieldsArray}
            />
            <Field
              ...
              fields={props.fields}
              name="Image field"
              selected={props.imgFieldName}
              setImageField={props.setImageField}
              applicationID={props.applicationID}
              fieldsArray={props.fieldsArray}
            />
            <AppName
              ...
              saveApplicationData={props.saveApplicationData}
              applicationID={props.applicationID}
            />
            ...
            <BackgroundImage
              appBackgroundImage={props.appBackgroundImage}
              updateApplicationData={props.updateApplicationData}
              saveApplicationData={props.saveApplicationData}
              applicationID={props.applicationID}
            />
            <Theme
              applicationTheme={props.applicationTheme}
              updateApplicationData={props.updateApplicationData}
              saveApplicationData={props.saveApplicationData}
              applicationID={props.applicationID}
            />
